...
def continuous_hopfield(S, W, V_new, max_epochs, lmda=10, dt=0.01, flag=0, every=10, size=(90,100)):
	...
	for j in range(V.shape[1]):
		visalize_image_reconstruction(S[:,j].reshape(-1,1), V[:,j].reshape(-1,1), V_new[:,j].reshape(-1,1), title="Epochs:" + str(i+1) + "; " + names[j])
...
lmda = 20
dt = 0.01
rmse, V_final, V_hist_0 = continuous_hopfield(S, W, V_new, max_epochs, lmda=lmda, dt=dt, flag=1, every=10)
...
max_epochs = 40
p = 0.25
rmse, V_final, V_hist_25 = continuous_hopfield(S, damage_weights(W, p), V_new, max_epochs, lmda=lmda, dt=dt, flag=1, every=10)
...
p = 0.50
max_epochs = 50
rmse, V_final, V_hist_50 = continuous_hopfield(S, damage_weights(W, p), V_new, max_epochs, lmda=lmda, dt=dt, flag=1, every=10)
...
p = 0.80
max_epochs = 70
rmse, V_final, V_hist_80 = continuous_hopfield(S, damage_weights(W, p), V_new, max_epochs, lmda=lmda, dt=dt, flag=1, every=10)
